/*
    ...
    This is a basic (and crappy) scripting language. It controls the mouse and keyboard and has the ability of most stuff from chalk.
...
function processLine(Line, i) {
    commands.forEach(element => {
        if (!`${Line}`.startsWith('//')) {
            if (`${Line}`.includes('//')) {
                throw console.error('Note unexpected.');
            } else {
